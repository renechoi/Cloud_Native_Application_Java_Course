...
public class ToListCollectorEx<T> implements Collector<T, List<T>, List<T>> {
    @Override
    ...
    public Set<Characteristics> characteristics() {
        return Collections.unmodifiableSet(EnumSet.of(
                Characteristics.IDENTITY_FINISH, Characteristics.CONCURRENT));      // 컬렉터의 플래그를 IDENTITY_FINISH, CONCURRENT로 설정한다
    }
}
